...
def parse_args():
    ...
    parser.add_argument('--savepath', type=str, default='checkpoint/model_weights_age', help='save checkpoint path')
    ...
    parser.add_argument('--mode', type=str, default='val', choices=['val', 'test', 'train'],
                        help='dataset type for evaluation only')
...
def main():
    ...
    testDataset = datasets.ImageFolder("custom_data/dataset_age/Test", transform=transform)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        val_loss, accuracy, percision, recall = round(val_loss, 3), round(accuracy, 3), round(percision, 3), round(
            recall, 3)
