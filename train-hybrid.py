...
def main():
    ...
    trainDataset = datasets.ImageFolder("custom_data/dataset_hybrid/Train", transform=transform)
    testDataset = datasets.ImageFolder("custom_data/dataset_hybrid/Test", transform=transform)
